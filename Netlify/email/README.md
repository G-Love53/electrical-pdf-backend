# Electrical Insurance Direct — Instantly email creatives

Hosted on **electricalinsurancedirect.com** via `electrical-pdf-backend/Netlify/email/`.
...
| **JPEG** | `CID_Electrical_Creative.jpg` |
| **Instantly HTML** | `instantly_step3.html` |
| **Public JPEG URL** | https://electricalinsurancedirect.com/email/archive/2026-08-connect-v1/CID_Electrical_Creative.jpg |
...
node scripts/extract-creative-jpg.mjs \
  ...
  --output ~/GitHub/electrical-pdf-backend/Netlify/email/archive/2026-08-connect-v1/CID_Electrical_Creative.jpg
```
